                ...
                <div class="card card-2">
                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="input-group">
                                <input class="input--style-2" type="text" placeholder="username" name="cus_username" Required>
                            </div>
                            <div class="input-group">
                                <input class="input--style-2" type="password" placeholder="password" name="cus_password" Required>
                            </div>
                            <!--<div class="input-group">
                            <tr>
                            ...
                            <div class="p-t-30 center">
                                <button class="btn btn--radius btn--green" type="submit">Login</button><br>
                                Not a member? <br>
                                <a href="register.php" target="_blank" rel="">Register for member</a><br>
                                <a href="./website/regis_drive.php" target="_blank" rel="">Register for driver</a><br>
                                <a href="./website/regis_shop.php" target="_blank" rel="">Register for shop</a>
                            </div>
                        </form>
                    </div>
                </div>
